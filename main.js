...
request1.onreadystatechange = function askWeather() {
    if (this.readyState == XMLHttpRequest.DONE && this.status == 200) {
        ...
        ask.addEventListener("click",function() {
            ...
            result3.innerHTML="<div><p>"+response.fcst_day_1.day_long+"</p><p>Temps : "+response.fcst_day_1.condition+"</p><p>Température min : "+response.fcst_day_1.tmin+" ‎°C</p><p>Température max : "+response.fcst_day_1.tmax+" ‎°C</p><img src="+response.fcst_day_1.icon+"></div>";
            result4.innerHTML="<div><p>"+response.fcst_day_2.day_long+"</p><p>Temps : "+response.fcst_day_2.condition+"</p><p>Température min : "+response.fcst_day_2.tmin+" ‎°C</p><p>Température max : "+response.fcst_day_2.tmax+" ‎°C</p><img src="+response.fcst_day_2.icon+"></div>";
            result5.innerHTML="<div><p>"+response.fcst_day_3.day_long+"</p><p>Temps : "+response.fcst_day_3.condition+"</p><p>Température min : "+response.fcst_day_3.tmin+" ‎°C</p><p>Température max : "+response.fcst_day_3.tmax+" ‎°C</p><img src="+response.fcst_day_3.icon+"></div>";
            result6.innerHTML="<div><p>"+response.fcst_day_4.day_long+"</p><p>Temps : "+response.fcst_day_4.condition+"</p><p>Température min : "+response.fcst_day_4.tmin+" ‎°C</p><p>Température max : "+response.fcst_day_4.tmax+" ‎°C</p><img src="+response.fcst_day_4.icon+"></div>";
        })
    }
};
